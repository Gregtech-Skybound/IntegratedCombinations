...
import org.cyclops.integrateddynamicscompat.modcompat.charset.aspect.*;
...
public class CharsetAspects {
    ...
    public static final class Write {
        ...
        public static final class Pipe {
            ...
            public static <V extends IValue, T extends IValueType<V>, O> AspectBuilder<V, T, Pair<org.cyclops.integrateddynamicscompat.modcompat.charset.aspect.ShifterPart, O>> getShifter(AspectBuilder<V, T, Triple<PartTarget, IAspectProperties, O>> builder) {
                return builder.handle(new IAspectValuePropagator<Triple<PartTarget, IAspectProperties, O>, Pair<org.cyclops.integrateddynamicscompat.modcompat.charset.aspect.ShifterPart, O>>() {
                    @Override
            ...
            public static final IAspectWriteActivator ACTIVATOR = new IAspectWriteActivator() {
                ...
                public <P extends IPartTypeWriter<P, S>, S extends IPartStateWriter<P>> void onActivate(P partType, PartTarget target, S state) {
                    state.addVolatileCapability(CharsetPipesModCompat.SHIFTER, new org.cyclops.integrateddynamicscompat.modcompat.charset.aspect.ShifterPart<>(target.getCenter().getSide(), partType, state));
            ...
            public static final IAspectWrite<ValueTypeBoolean.ValueBoolean, ValueTypeBoolean> SHIFTER_BOOLEAN =
                    getShifter(AspectWriteBuilders.BUILDER_BOOLEAN.appendKind("charsetpipe")
                            ...
                            .handle(new IAspectValuePropagator<Pair<org.cyclops.integrateddynamicscompat.modcompat.charset.aspect.ShifterPart, ValueTypeBoolean.ValueBoolean>, Void>() {
                                @Override
                                public Void getOutput(Pair<org.cyclops.integrateddynamicscompat.modcompat.charset.aspect.ShifterPart, ValueTypeBoolean.ValueBoolean> input) throws EvaluationException {
                                    org.cyclops.integrateddynamicscompat.modcompat.charset.aspect.ShifterPart shifter = input.getLeft();
            ...
            public static final IAspectWrite<ValueObjectTypeItemStack.ValueItemStack, ValueObjectTypeItemStack> SHIFTER_ITEMSTACK =
                    getShifter(AspectWriteBuilders.BUILDER_ITEMSTACK.appendKind("charsetpipe")
                            .appendActivator(ACTIVATOR).appendDeactivator(DEACTIVATOR).appendKind("shifter"))
                            .handle(new IAspectValuePropagator<Pair<org.cyclops.integrateddynamicscompat.modcompat.charset.aspect.ShifterPart, ValueObjectTypeItemStack.ValueItemStack>, Void>() {
                                @Override
                                public Void getOutput(Pair<org.cyclops.integrateddynamicscompat.modcompat.charset.aspect.ShifterPart, ValueObjectTypeItemStack.ValueItemStack> input) throws EvaluationException {
                                    org.cyclops.integrateddynamicscompat.modcompat.charset.aspect.ShifterPart shifter = input.getLeft();
            ...
            public static final IAspectWrite<ValueTypeList.ValueList, ValueTypeList> SHIFTER_LISTITEMSTACK =
                    getShifter(AspectWriteBuilders.BUILDER_LIST.appendKind("charsetpipe")
                            .appendActivator(ACTIVATOR).appendDeactivator(DEACTIVATOR).appendKind("shifter"))
                            .handle(new IAspectValuePropagator<Pair<org.cyclops.integrateddynamicscompat.modcompat.charset.aspect.ShifterPart, ValueTypeList.ValueList>, Void>() {
                                @Override
                                public Void getOutput(Pair<org.cyclops.integrateddynamicscompat.modcompat.charset.aspect.ShifterPart, ValueTypeList.ValueList> input) throws EvaluationException {
                                    org.cyclops.integrateddynamicscompat.modcompat.charset.aspect.ShifterPart shifter = input.getLeft();
            ...
            public static final IAspectWrite<ValueTypeOperator.ValueOperator, ValueTypeOperator> SHIFTER_PREDICATEITEMSTACK =
                    getShifter(AspectWriteBuilders.BUILDER_OPERATOR.appendKind("charsetpipe")
                            .appendActivator(ACTIVATOR).appendDeactivator(DEACTIVATOR).appendKind("shifter"))
                            .handle(new IAspectValuePropagator<Pair<org.cyclops.integrateddynamicscompat.modcompat.charset.aspect.ShifterPart, ValueTypeOperator.ValueOperator>, Void>() {
                                @Override
                                public Void getOutput(Pair<org.cyclops.integrateddynamicscompat.modcompat.charset.aspect.ShifterPart, ValueTypeOperator.ValueOperator> input) throws EvaluationException {
                                    org.cyclops.integrateddynamicscompat.modcompat.charset.aspect.ShifterPart shifter = input.getLeft();
            ...
            public static final IAspectWrite<ValueObjectTypeFluidStack.ValueFluidStack, ValueObjectTypeFluidStack> SHIFTER_FLUIDSTACK =
                    getShifter(AspectWriteBuilders.BUILDER_FLUIDSTACK.appendKind("charsetpipe")
                            ...
                            .handle(new IAspectValuePropagator<Pair<org.cyclops.integrateddynamicscompat.modcompat.charset.aspect.ShifterPart, ValueObjectTypeFluidStack.ValueFluidStack>, Void>() {
                                @Override
                                public Void getOutput(Pair<org.cyclops.integrateddynamicscompat.modcompat.charset.aspect.ShifterPart, ValueObjectTypeFluidStack.ValueFluidStack> input) throws EvaluationException {
                                    org.cyclops.integrateddynamicscompat.modcompat.charset.aspect.ShifterPart shifter = input.getLeft();
